...
if(isset($_POST['save_email'])) {
    $new_email = mysqli_real_escape_string($conn, $_POST['emailid']);
    
    // Update the user's email in the database
    $sql_update_email = "UPDATE user SET emailid = '$new_email' WHERE id = '".$_SESSION['rainbow_uid']."'";
    $result_update_email = $conn->query($sql_update_email);
...
echo '<div class="alert alert-success">
  <a href="#" class="close" data-dismiss="alert" aria-label="close">&times;</a>
  <strong>Success!</strong> Email Id Changed Successfully.
</div>';
				...
				<div class="row">
					<div class="col-sm-8 col-sm-offset-2">
						<div class="panel panel-success">
							...
							<form action="setting.php" method="post" id="signupForm2" class="form-horizontal">
								<div class="panel-body">
									<div class="form-group">
									...
									<div class="form-group">
										<div class="col-sm-9 col-sm-offset-4">
											<button type="submit" name="save_email" class="btn btn-success" style="border-radius:0%">Make Changes </button>
										</div>
									</div>
								</div>
							</form>

...
<body>
    ...
    <div id="page-wrapper">
        <nav class="navigation-bar">
            <ul class="list-items">
                <li class="item"><a class="link" style="color: #6719bd;" href="javascript:void(0)" onclick="showChart('barChart')"> Std's Fees</a></li>
                <li class="item"><a class="link" style="color: #6719bd;" href="javascript:void(0)" onclick="showChart('pieChart')">Fees</a></li>
                <li class="item"><a class="link" style="color: #6719bd;" href="javascript:void(0)" onclick="showChart('genderChart')">Gender</a></li>
                <li class="item"><a class="link" style="color: #6719bd;" href="javascript:void(0)" onclick="showChart('commChart')">Community</a></li>
                <li class="item"><a class="link" style="color: #6719bd;" href="javascript:void(0)" onclick="showChart('gradeChart')">Course</a></li>
                <li class="item"><a class="link" style="color: #6719bd;" href="javascript:void(0)" onclick="showChart('payChart')">Payment</a></li>
                <li class="item"><a class="link" style="color: #6719bd;" href="javascript:void(0)" onclick="showChart('transChart')">Transaction</a></li>
                <li class="item"><a class="link" style="color: #6719bd;" href="javascript:void(0)" onclick="showChart('busChart')"> Bus</a></li>
                <li class="item"><a class="link" style="color: #6719bd;" href="javascript:void(0)" onclick="showChart('vanChart')">Van</a></li>
                <li class="item"><a class="link" style="color: #6719bd;" href="javascript:void(0)" onclick="showChart('skillChart')">Skill</a></li>
            </ul>
        ...
        <div class="chart-container" id="pieChart" style="display: none;">
            <h2 align="center">Number of Students with Fees</h2>
            <canvas id="feePieChart"></canvas>
        </div>

        <div class="chart-container" id="genderChart" style="display: none;">
            <h2 align="center">Gender Distribution</h2>
            <canvas id="genderChartCanvas"></canvas>
        </div>
        <div class="chart-container" id="commChart" style="display: none;">
            <h2 align="center">Community Distribution</h2>
            <canvas id="commChartCanvas"></canvas>
        </div>

        <div class="chart-container" id="gradeChart" style="display: none;">
            <h2 align="center">Course Distribution</h2>
            <canvas id="gradeChartCanvas"></canvas>
        </div>
        <div class="chart-container" id="payChart" style="display: none;">
            <h2 align="center">Total Payment Count</h2>
            <canvas id="paymentModeChart"></canvas>
        </div>
        <div class="chart-container" id="transChart" style="display: none;">
            <h2 align="center">Total Transaction Count</h2>
            <canvas id="transactionChart"></canvas>
        </div>
        <div class="chart-container" id="busChart" style="display: none;">
            <h2 align="center">Total Bus Route</h2>
            <canvas id="busRouteChart" ></canvas>
        </div>
        <div class="chart-container" id="vanChart" style="display: none;">
            <h2 align="center">Total Van Route</h2>
            <canvas id="vanRouteChart" ></canvas>
        </div>
        <div class="chart-container" id="skillChart" style="display: none;">
...
document.addEventListener('DOMContentLoaded', function() {
    var items = document.querySelectorAll('.navigation-bar .list-items .item');

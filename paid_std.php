...
<div id="page-wrapper">
            <div id="page-inner">
                <div class="row">
                    <div class="col-md-12">
                        <h1 class="page-head-line">Fully Paid Student
						<?php
						echo '<a href="unpaid_std.php" class="btn btn-success btn-sm pull-right" style="border-radius:0%">Go Back </a>';
                        ?>
						</h1>
         ...
         <div class="panel panel-default">
                         ...
                         <div class="panel-body">
                              <div class="table-sorting table-responsive">
                                 ...
                                 <table class="table table-striped table-bordered table-hover" id="tSortable20">
                                 <thead>
                                        <tr>
                                            <th>#</th>
                                            <th>Name | Reg No</th>
                                    ...
                                    <tbody>
									<?php
									$sql = "select * from student where delete_status='0' and balance='0'";
									$q = $conn->query($sql);
									$i=1;
                         ...
                         <div class="panel-body">
                              <div class="table-sorting table-responsive">
                                 ...
                                 <thead>
                                    ...
                                    <tbody>
									<?php
									$sql = "select * from student where delete_status='0' and classfee!='' and classpaid=classfee";
									$q = $conn->query($sql);
									$i=1;
                         ...
                         <div class="panel-body">
                              <div class="table-sorting table-responsive">
                                 ...
                                 <thead>
                                    ...
                                    <tbody>
									<?php
									$sql = "select * from student where delete_status='0' and busfee!='' and buspaid=busfee";
									$q = $conn->query($sql);
									$i=1;
                         ...
                         <div class="panel-body">
                              <div class="table-sorting table-responsive">
                                 ...
                                 <thead>
                                    ...
                                    <tbody>
									<?php
									$sql = "select * from student where delete_status='0' and vanfee!='' and vanpaid=vanfee";
									$q = $conn->query($sql);
									$i=1;
                         ...
                         <div class="panel-body">
                              <div class="table-sorting table-responsive">
                                 ...
                                 <thead>
                                    ...
                                    <tbody>
									<?php
									$sql = "select * from student where delete_status='0' and skillfee!='' and skillpaid=skillfee";
									$q = $conn->query($sql);
									$i=1;
                         ...
                         <div class="panel-body">
                              <div class="table-sorting table-responsive">
                                 ...
                                 <thead>
                                    ...
                                    <tbody>
									<?php
									$sql = "select * from student where delete_status='0' and otherfee!='' and otherpaid=otherfee";
									$q = $conn->query($sql);
									$i=1;
